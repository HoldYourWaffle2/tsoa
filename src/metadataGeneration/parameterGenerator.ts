...
export class ParameterGenerator {
  ...
  private getQueryParameter(parameter: ts.ParameterDeclaration): Tsoa.Parameter {
    ...
    if (type.dataType === 'tuple') { // CHECK test tuple handling
  ...
  private supportParameterDecorator(decoratorName: string) {
    return ['header', 'query', 'parem', 'body', 'bodyprop', 'request'].some((d) => d === decoratorName.toLocaleLowerCase()); // XXX 'parem' typo?
  }
